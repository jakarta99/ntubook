      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-9 mx-auto">
            <h1 class="mb-5">Find the book you want!</h1>
          </div>
          <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
            <form>
              <div class="form-row">
                <div class="col-12 col-md-9 mb-2 mb-md-0">
                  <input type="email" class="form-control form-control-lg" placeholder="Enter the book...">
                </div>
        ...
        <div class="row">
          <div class="col-md-4 col-sm-6 portfolio-item">
            ...
            <div class="portfolio-caption">
              <h4>Book1</h4>
              <p class="text-muted">course1</p>
              <p class="text-muted">professor1</p>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 portfolio-item">
            ...
            <div class="portfolio-caption">
              <h4>Book2</h4>
              <p class="text-muted">course2</p>
              <p class="text-muted">professor2</p>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 portfolio-item">
            ...
            <div class="portfolio-caption">
              <h4>Book3</h4>
              <p class="text-muted">course3</p>
              <p class="text-muted">professor3</p>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 portfolio-item">
            ...
            <div class="portfolio-caption">
              <h4>Book4</h4>
              <p class="text-muted">course4</p>
              <p class="text-muted">professor4</p>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 portfolio-item">
            ...
            <div class="portfolio-caption">
              <h4>Book5</h4>
              <p class="text-muted">course5</p>
              <p class="text-muted">professor5</p>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 portfolio-item">
            ...
            <div class="portfolio-caption">
              <h4>Book6</h4>
              <p class="text-muted">course6</p>
              <p class="text-muted">professor6</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <input class="form-control" id="name" type="text" placeholder="Book Name *" required="required" data-validation-required-message="Please enter your name.">
                    <p class="help-block text-danger"></p>
                  </div>
                  <div class="form-group">
                    <input class="form-control" id="email" type="email" placeholder="Course *" required="required" data-validation-required-message="Please enter your email address.">
                    <p class="help-block text-danger"></p>
                  </div>
                  <div class="form-group">
                    <input class="form-control" id="phone" type="tel" placeholder="Professor *" required="required" data-validation-required-message="Please enter your phone number.">
                    <p class="help-block text-danger"></p>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <textarea class="form-control" id="message" placeholder="Description *" required="required" data-validation-required-message="Please enter a message."></textarea>
                    <p class="help-block text-danger"></p>
                  </div>
                </div>
